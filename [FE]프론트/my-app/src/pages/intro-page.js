  ...
  return (
    ...
    <SIntroPageWrapper>
      ...
      <div className="content" data-aos="fade-up" style={{"margin-top":"200px"}}>
        <img src={process.env.PUBLIC_URL + '/mz2.png'} style={ {width:'500px', height: '500px'}}  alt="placeholder" />
        
        <div className="intro-text">
          <h1>누구나 볼 수 있는 성취의 순간,<br/>크릿을 만나보세요!</h1>
          <p style={ {color : "grey"}}>
      ...
      <img src={process.env.PUBLIC_URL + '/introimg1.png'} style={ {width:'500px', height: '500px'}} alt="placeholder" />
        <div className="intro-text">
          <h1>함께 성장하는 <br/>챌린지 커뮤니티</h1>
          <p style={ {color : "grey"}}>
