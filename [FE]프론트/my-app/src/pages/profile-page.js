...
import { SFeedButton, SProfileWrapper, Empty, Row, Col, OpacityZero, SProfileImg, SProfileImgCover, FeedGrid } from "../styles/pages/SProfilePage";
      ...
      <SProfileWrapper>
        <Row>
          ...
          <Row>
            ...
            <a>팔로워<br />{followersCount}</a>
            <a>팔로잉<br />{followingCount}</a>
          </Row>
