...
public class MemberRequestDto {
    ...
    static MemberRequestDto toMemberRequestDto(Member member) {
    ...
    static List<MemberRequestDto> toMemberRequestDto(List<Member> members) {
        return members.stream()
                .map(MemberRequestDto::toMemberRequestDto)
                .collect(Collectors.toList());
    }
}
